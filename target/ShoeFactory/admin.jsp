...
<body>
	<div class="bg-img">
		...
		data-target="#add-category-modal"> <!-- category modal -->
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form action="ProductOperationServlet" method="post">
						...
						<div class="form-group"> <!-- rule of bootstrap to put form in form-group  -->
						...
						<div class="form-group"> <!-- rule of bootstrap to put form in form-group  -->
							...
							<textarea style="height:150px" class="form-control" placeholder="Enter category description" name="CategoryDesc"></textarea>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form action="ProductOperationServlet" method="post">
						...
						<div class="form-group"> <!-- Product desc  -->
							
							<input type="text" class="form-control" placeholder="Enter product description" name="Productdesc"/>
				
						</div>
						
						<div class="form-group"> <!-- Product Photo -->
							
							<input type="text" class="form-control" placeholder="Enter product photo" name="Productphoto" required/>
						...
						<div class="form-group"> <!-- Product discount -->
							...
							<input type="text"  class="form-control" placeholder="Enter product discount" name="Productdiscount"/>
				
						</div>
						
						<div class="form-group"> <!-- Product quantity -->
							
							<input type="text"  class="form-control" placeholder="Enter product quantity" name="Productquantity"/>
